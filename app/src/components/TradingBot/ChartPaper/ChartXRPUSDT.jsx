...
const ChartXRPUSDT = () => {
    ...
    function prepareChart(chart) {
        ...
        fetch('http://localhost:5000/XRPUSDT_candlesticks')
        .then((r) => r.json())
        .then((response) => {
            candleSeries.setData(response);
        });

        const binanceSocket = new WebSocket('wss://fstream.binance.com/stream?streams=xrpusdt@kline_1h/');
